...
This project will make up 15% of your total grade. Base on a research dataset, you will draft a research proposal with research title, background, hypothesis, methods, and expected outcome. Make this project as a research proposal that you are going to apply funding with. There will be a 5-minutes presentation component as well as a 2-pages report.
...
Yi-Chin (Sunny) Tseng. 2018. [Automatic Bird Sound Detection in Audio by Spectral Features](./docs/BirdID_vogel_Sunny_20180209.pdf){width=75%}.
