...
-   `terra`: for spatial analysis

### Install and call a package in your environment

::: columns
::: {.column width="50%"}
Install package: only need do it once in your liftetime
...
::: {.column width="50%"}
Call package: need to do it everytime when you reopen R
