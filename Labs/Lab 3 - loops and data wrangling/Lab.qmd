...
### Create: apply math with other column(s)

```{r, echo = TRUE, eval = FALSE}
penguins %>%
  mutate(bill_area = bill_depth_mm * bill_length_mm)
```
...
### Keep the columns that you want
...
![](images/ed07d56b-c5c8-43af-84be-5bcab97eca75-01.png){width="687"}
...
penguins %>%
  ...
  relocate(ID, .after = island) # .before is another argument
```
:::

::: {.column width="50%"}
![](images/850e4954-e2c6-4df1-a3c0-34764a05a3df.png){width="678"}
:::
:::
