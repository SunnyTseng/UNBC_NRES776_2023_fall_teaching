...
This is the model equation that we are going to fit. Explain why there are three parameters **(5 pt)**
...
Fit a Poisson using `glm()` function. Specify the arguments: `formula`, `data`, and `family`. We will use the default link function, which is a log link. **(5 pt)**
...
Then, use the `summary()` function to print the model output. **(5 pt)**
...
The model output indicated the estimated values for the parameters, and model statistics. Report these values. (Hint: use `exp()` function and `coef()` function to get exponential value easier) **(5 pt)**
...
Hypothesis of the likelihood ratio test (in words) **(5 pt)**

$H_0$: *Write your answer here*

$H_a$: *Write your answer here*

First, we need to fit a null model **(3 pt)**
...
Then, run a likelihood ratio test **(2 pt)**
...
What is your decision based on this likelihood ratio test? (Hint: provide the p-value, the $\alpha$ threshold you are comparing with, and your conclusion) **(5 pt)**

*Write your answer here*

## Model result interpretation

Calculate the predicted mean number of satellites for horsecrab with Light colour. Show the calculation process. **(5 pt)**

*Write your answer here*

Calculate the predicted mean number of satellites for horsecrab with Dark colour. Show the calculation process. **(5 pt)**

*Write your answer here*

Is your modelling result showing the same pattern as you observed in the boxplot? Is colour of female horseshoe crab significantly influencing the number of satellite? Explain why or why not, use the model output value as needed. **(5 pt)**

*Write your answer here*

## 2. Poisson regression - horseshoe crab - categorical
...
Write out the equation that we are going to fit using Poisson regression. Explain why we only have one predictor variable here. Is the following equation correct? If not, fix it. **(5 pt)**
...
Is the model including carapace width (W) as predictor variable better than a null model? Use a likelihood ratio test to test it. Write out the hypotheses of the likelihood ratio test (in words) **(5 pt)**
...
Write out the model equation. Explain why there are two predictor variables in the equation. **(5 pt)**

$$ logit(p_i) = \beta_0 + \beta_1 x_{1i} + \beta_2 x_{2i} $$

*Write your answer here*

Fit a Binomial regression using `glm()` function. Specify the arguments: `formula`, `data`, and `family`. We will use the default link function, which is a logit link. **(5 pt)**
...
Calculate the odds of a passenger being survived if they are sitting in first class. Show the calculation process. **(5 pt)**

*Write your answer here*

Calculate the survival odds ratio of sitting in third class comparing to sitting in the first class. Show the calculation process. **(5 pt)**

*Write your answer here*

Is your modelling result showing the same pattern as you observed in the scatter plot? Is passenger class a significant variable to explain survival rate? Explain why or why not, use the model output value as needed. **(5 pt)**
