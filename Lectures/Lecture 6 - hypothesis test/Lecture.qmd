...
> Definition: the probability of rejecting the null hypothesis $H_0$ when it's true. In other words, we have 5% (0.05) risk of making type I error.
...
-   You might not making mistake in rejecting $H_0$ when it's true

-   But at the same time, you might not reject $H_0$ when it's not true - $\beta$ type II error
