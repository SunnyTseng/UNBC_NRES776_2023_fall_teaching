...
2.  Poisson and Logistic (bionomial) regression
...
-   **N**ormality: Response variables are not always normally distributed, continuous, ranging from $- \infty$ to $\infty$

-   **E**qual variance: Variance may change as a function of the means
...
2.  Link function $g()$ --\> **logit**, makes $(0, 1)$ to $(-\infty, \infty)$
...
## Distributions and links (GLM in a slide)
